    ...
    return (
        ...
        <div className="nav-brand-and-account-container">
          <div className="nav-items-container">
            ...
            <div className="globalnav-account">
                ...
                <div style={{position:'relative'}}>
                  <div className="account-bar">
                    ...
                    <div className="account-image">
                      <img src={abProfile} alt="profile" width="100%" height="100%" />
                    </div>
                  </div>
                  <div className="account-msg-count"><div style={{display:'block',margin:'auto 0px',height:'100%'}}>3</div></div> 
                </div>
              </div>
            </div>  
          </div>  
                  ...
                  <div className="form-container" onBlur={collapseSearch}>
                    <div className="input-container stretchy tab-start" style={{minWidth: '25%'}}>
                      <div className="field-lockup">
                        ...
                        <input className="flexible-input" type="text" name="location" id="location" placeholder="Where are you going?" />  
                      </div>
                    </div>
                    <div className="dividing-line"></div>
                    <div className="input-container shrinky">
                      <div className="field-lockup">
                        <label className="input-label" htmlFor="location">Check In</label>
                        <input className="flexible-input date"  type="text" name="location" id="location" placeholder="Add dates" />  
                      </div>
                    </div>
                    <div className="dividing-line"></div>
                    <div className="input-container shrinky">
                      <div className="field-lockup">
                        <label className="input-label" htmlFor="location">Check Out</label>
                        <input className="flexible-input date"  type="text" name="location" id="location" placeholder="Add dates" />  
                      </div>
                    </div>
                    <div className="dividing-line"></div>
                    <div className="input-container shrinky">
                      <div className="field-lockup">
                        <label className="input-label" htmlFor="location">Guests</label>
                        <input className="flexible-input"  type="text" name="location" id="location" placeholder="Add guests" />
                      </div>
                      <div className="search-button-large">
                        <div className="search-button-large-content">
                          <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style={{display: 'block', fill: 'none', height: '16px', width: '16px', stroke: 'currentcolor', strokeWidth: 4.33333, overflow: 'visible'}}><g fill="none"><path d="m13 24c6.0751322 0 11-4.9248678 11-11 0-6.07513225-4.9248678-11-11-11-6.07513225 0-11 4.92486775-11 11 0 6.0751322 4.92486775 11 11 11zm8-3 9 9"></path></g></svg>
                        </div>
                        <div className="search-button-large-content">
                          Search&nbsp;&nbsp;
                        </div>
