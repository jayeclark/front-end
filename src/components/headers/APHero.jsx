import Cta from '../ctas/APCta.jsx';

export function Hero({title, logoImgs, lockupImgs, svgArray, classArray, ctaType}) {

  const {logoSm, logoSm2x, logoM, logoM2x, logoL, logoL2x} = logoImgs;
  const {heroSm, heroSm2x, heroM, heroM2x, heroL, heroL2x} = lockupImgs;
  const svgArray = [{name: 'large',
                         fill: '#231F20',
                         fillRule: 'evenodd',
              ...
              <div className="copy-container">
                ...
                <div className="link-wrapper">
                  ...
                  <div className="headline">
                    <picture id="overview-iphone-13-pro-logo-1" dataLazy="true" dataPictureLoaded="true">
                  ...
                  <Cta type={ctaType} topic={title.toLowerCase()} className={classArray.general}></Cta>
                </div>  
              </div>
